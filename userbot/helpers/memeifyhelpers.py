...
from wand.image import Image as exelonimage
...
async def exelon_meme(topString, bottomString, filename, endname):
...
async def exelon_meeme(upper_text, lower_text, picture_name, endname):
    main_image = exelonimage(filename=picture_name)
